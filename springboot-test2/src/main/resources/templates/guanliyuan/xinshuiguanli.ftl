        ...
        function submitData() {
            ...
            $.ajax({
                ...
                success : function (map) {
                    ...
                    setTimeout(function(){
                    window.location.href="../guanliyuan/xinshuiguanli";
                    }, 3000);
                },
            })
        }
                    ...
                    success : function (pb) {
                        ...
                        for (var i = 0; i < pb.list.length; i++) {
                            ...
                            var li='<tr>\n' +
                                    ...
                                    '                <td> '+teacher.waipin+'</td>\n' +
                                    '                <td> '+teacher.paiqian+'</td>\n' +
                                    '                <td>\n' +
                                    '                    <a  href="#" id="edit" class="edit" >编辑</a>\n' +
                                    '                    <a  href="xinshuidel?xinshuiid='+teacher.id+'" id="del" class="del">删除</a>\n' +
                                    '                </td>\n' +
                                    '            </tr>';
                            lis+=li;
                        }
                ...
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            ...
                            <li><a class="active" href="chufaguanli"><span>处罚等级管理</span></a></li>
                        </ul>
                    </li>
                    <li class="lsm-sidebar-item">
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            ...
                            <li><a  class="active" href="xinshuiguanli"><span>薪资标准管理</span></a></li>
                        </ul>
                    </li>
                    <li class="lsm-sidebar-item">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table id="xztb" class="table">
                                        ...
                                        <tr>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>外聘制薪水单价/每学时</label>
                                            </td>
                                            <td><input id="waipin" name="waipin" class="waipin" type="text" placeholder="请输入"/></td>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>派遣制薪水单价/每月</label>
                                            </td>
                                            <td><input id="paiqian" name="paiqian" class="paiqian" type="text" placeholder="请输入"/></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
