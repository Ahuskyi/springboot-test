...
<#--<分页>-->
    ...
    <script>
        ...
        function submitData() {
            ...
            var data = {
                id : $("#id").val(),
                zuidifen : $("#zuidifen").val(),
                zuigaofen : $("#zuigaofen").val(),
                dengji : $("#dengji").val(),
            };
            var url = "zonghepingdingjieguoxiugai";
            $.ajax({
                url : url,
                type : "post",
                data : data,
                ...
                success : function (map) {
                    ...
                    setTimeout(function(){
                        window.location.href="../guanliyuan/zonghepingdingjieguoguanli";
                    }, 3000);
                },
        ...
        function loaddate(currentPage) {
                ...
                var url = "zonghepingdingjieguofenye"
                $.ajax({
                    url : url,
                    type : "get",
                    data : data,
                    ...
                    success : function (pb) {
                        ...
                        for (var i = 0; i < pb.list.length; i++) {
                            ...
                            var li='<tr>\n' +
                                    '                <td> '+teacher.id+'</td>\n' +
                                    '                <td> '+teacher.zuidifen+'</td>\n' +
                                    '                <td> '+teacher.zuigaofen+'</td>\n' +
                                    '                <td> '+teacher.dengji+'</td>\n' +
                                    '                <td>\n' +
                                    '                    <a  href="#" id="edit" class="edit" >编辑</a>\n' +
                                    '                    <a  href="zonghepingdingjieguodel?zonghepingdingjieguoid='+teacher.id+'" id="del" class="del">删除</a>\n' +
                                    '                </td>\n' +
                                    '            </tr>';
                            lis+=li;
                        }
                ...
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            ...
                            <li><a class="active" href="zonghepingdingjieguoguanli"><span>综合评定结果</span></a></li>
                                ...
                                <div class="modal-body">
                                    <table id="xztb" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>最低分</label></td>
                                            <td><input  id="zuidifen" name="zuidifen" class="zuidifen" type="text" placeholder="请输入最低分"/></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>最高分</label></td>
                                            <td><input id="zuigaofen" name="zuigaofen" class="zuigaofen" type="text" placeholder="请输入最高分"/></td>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>等级</label></td>
                                            <td><input id="dengji" name="dengji" class="dengji" type="text" placeholder="请输入等级"/></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
