    ...
    <script>
        ...
        $(function () {
            ...
            $('#back_btn').click(function () {
                $('#search_zhuanjiaid').val('');
                $('#search_zhuanjiaxingming').val('');
                methods.resectList();
                loaddate();
            })
            $('.del').click(function () {
            ...
            var methods = {
                new:function(){
                    ...
                    var text="请选择";
                    $("#xingbie").prepend("<option value='"+text+"' selected='selected'>"+text+"</option>");
                },
            ...
            if (a) {
                ...
                $.ajax({
                    ...
                    success: function (map) {
                        ...
                        setTimeout(function () {
                            window.location.href = "../guanliyuan/zhuajiaguanli";
                        }, 3000);
                    },
        ...
        function loaddate(currentPage) {
                ...
                var data = {
                    ...
                    search_zhuanjiaid : $("#search_zhuanjiaid").val(),
                    search_zhuanjiaxingming : $("#search_zhuanjiaxingming").val(),
                }
                var url = "zhuanjiafenye"
                $.ajax({
                    url : url,
                    type : "get",
                    data : data,
                    ...
                    success : function (pb) {
                        ...
                        for (var i = 0; i < pb.list.length; i++) {
                            ...
                            var li='<tr>\n' +
                                    ...
                                    '                <td> '+xuesheng.dianhua+'</td>\n' +
                                    '                <td> '+xuesheng.youxiang+'</td>\n' +
                                    '                <td>\n' +
                                    '                    <a  href="#" id="edit" class="edit" >编辑</a>\n' +
                                    '                    <a  href="zhuanjiadel?zhuanjiaid='+xuesheng.id+'" id="del" class="del">删除</a>\n' +
                                    '                </td>\n' +
                                    '            </tr>';
                            lis+=li;
                        }
            ...
            <div class="lsm-sidebar">
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            <li><a class="active" href="zhuajiaguanli"><span>专家管理</span></a></li>
                    ...
                    <div class="person_search">
                        <div class="search_input">
                            <div class="input-group mb-3">
                                <span>ID：</span>
                                <input id="search_zhuanjiaid" type="text" class="form-control" placeholder="请输入ID">
                            </div>
                        </div>
                        <div class="search_input">
                            <div class="input-group mb-3" >
                                <span>专家名：</span>
                                <input id="search_zhuanjiaxingming" type="text" class="form-control" placeholder="请输入专家姓名">
                            </div>
                        </div>
                        <div class="search_input">
                                ...
                                <div class="modal-body">
                                    <table id="xztb" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><select id="xingbie" name="xingbie"  class="form-control select_down" style="font-size: 13px; color: #666;" >
                                                <option>请选择</option>
