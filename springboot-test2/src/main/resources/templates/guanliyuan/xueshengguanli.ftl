        ...
        $(function () {
            ...
            var methods = {
                new:function(){
                    ...
                    $("#banjimingcheng").prepend("<option  selected='selected'>"+text+"</option>");
                },
                ...
                editHandle: function (the_index) {
                    ...
                    tarInp.eq(4).attr("value",nowConArr[6].toString().trim());
                    var xingbie=nowConArr[4].toString().trim();
                    var banjimingcheng=nowConArr[5].toString().trim();
                    tarSel.eq(0).get(0).remove(0);
                    tarSel.eq(1).get(0).remove(0);
                    tarSel.eq(0).prepend("<option value='"+xingbie+"' selected='selected'>"+xingbie+"</option>");
                    tarSel.eq(1).prepend("<option value='"+banjimingcheng+"' selected='selected'>"+banjimingcheng+"</option>");
        ...
        function submitData() {
            ...
            if (a) {
                var data = {
                    ...
                    xingbie: $("#xingbie").find("option:selected").text().trim(),
                    banji: $("#banjimingcheng").find("option:selected").text().trim(),
                    chuangjianshijian: $("#chuangjianshijian").val(),
                };
                var url = "xueshengxiugai";
                $.ajax({
                    url: url,
                    type: "post",
                    data: data,
                    ...
                    success: function (map) {
                        ...
                        setTimeout(function () {
                            window.location.href = "../guanliyuan/xueshengguanli"
                        }, 3000);
                    },
                    ...
                    success : function (pb) {
                        ...
                        for (var i = 0; i < pb.list.length; i++) {
                            ...
                            var li='<tr>\n' +
                                    ...
                                    '                <td> '+xuesheng.chuangjianshijian+'</td>\n' +
                                    '                <td>\n' +
                                    '                    <a  href="#" id="edit" class="edit" >编辑</a>\n' +
                                    '                    <a  href="xueshengdel?xueshengid='+xuesheng.xuehao+'" id="del" class="del">删除</a>\n' +
                                    '                </td>\n' +
                                    '            </tr>';
                            lis+=li;
                        }
            ...
            <div class="lsm-sidebar">
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            <li><a class="active" href="xueshengguanli"><span>学生管理</span></a></li>
                        </ul>
                    </li>
                    <li class="lsm-sidebar-item">
                    ...
                    <div class="person_search">
                        <div class="search_input">
                            <div class="input-group mb-3">
                                <span>学号：</span>
                                <input id="search_id" type="text" class="form-control" placeholder="请输入学号">
                            </div>
                        </div>
                        <div class="search_input">
                            <div class="input-group mb-3" >
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <table id="xztb" class="table">
                                        ...
                                        <tbody>
                                        <tr>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>学号</label></td>
                                            <td><input  id="xuehao" name="xuehao" class="xuehao" type="text" placeholder="自动生成"/></td>
                                        ...
                                        <tr>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>性别</label></td>
                                            <td>
                                            ...
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>班级</label></td>
                                            <td>
