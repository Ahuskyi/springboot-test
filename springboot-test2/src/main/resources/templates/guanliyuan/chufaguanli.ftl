    ...
    <script>
        ...
        $(function () {
            ...
            $('#show_tbody').on('click','.edit', function () {
               ...
               // $("#chufadengji").attr("readonly","readonly");
                $("#id").prop("readonly",true)
            ...
            var methods = {
                ...
                checkMustMes: function () {
                    ...
                    if ($('.chufadengji').val().trim()==='') {
                        bootbox.alert({
                            title: "来自火星的提示",
                            message: "处罚等级为必选项，请填写",
                            closeButton:false
                        })
                        hasNullMes = true;
                        return
                    }
                    if ($('.chufajine').val().trim()==='') {
                        bootbox.alert({
                            title: "来自火星的提示",
                            message: "处罚金额为必选项，请填写",
                            closeButton:false
                        })
                        hasNullMes = true;
                        return
        ...
        function submitData() {
            var data = {
                ...
                chufajine : $("#chufajine").val(),

            };
            var url = "chufadengjixiugai";
            $.ajax({
                url : url,
                type : "post",
                data : data,
            ...
            setTimeout(function(){
                window.location.href="../guanliyuan/chufaguanli";
            }, 3000);
                    ...
                    success : function (pb) {
                        ...
                        for (var i = 0; i < pb.list.length; i++) {
                            ...
                            var li='<tr>\n' +
                                    ...
                                    '                <td> '+teacher.chufajine+'</td>\n' +
                                    '                <td>\n' +
                                    '                    <a  href="#" id="edit" class="edit" >编辑</a>\n' +
                                    '                    <a  href="chufadengjidel?chufadengjiid='+teacher.id+'" id="del" class="del">删除</a>\n' +
                                    '                </td>\n' +
                                    '            </tr>';
                            lis+=li;
                        }
                ...
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            ...
                            <li><a  href="zhichengguanbli"><span>职称管理</span></a></li>
                            <li><a  href="zonghepingdingjieguo"><span>综合评定结果</span></a></li>
                                ...
                                <div class="modal-body">
                                    <table id="xztb" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>处罚等级</label></td>
                                            <td><input  id="chufadengji" name="chufadengji" class="chufadengji" type="text" placeholder="请输入处罚等级"/></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>处罚金额</label>
                                            </td>
                                            <td><input id="chufajine" name="chufajine" class="chufajine" type="text" placeholder="请输入处罚金额"/></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
