...
<#--<分页>-->
    ...
    <script>
        ...
        $(function () {
            ...
            var methods = {
                ...
                checkMustMes: function () {
                    ...
                    //     return
                    // }
                    if ($('.nianxianstart').val().trim()==='') {
                        bootbox.alert({
                            title: "来自火星的提示",
                            message: "年限开始为必选项，请填写",
                            closeButton:false
                        })
                        hasNullMes = true;
                        return
                    }
                    if ($('.nianxianend').val().trim()==='') {
                        bootbox.alert({
                            title: "来自火星的提示",
                            message: "年限结束为必选项，请填写",
                            closeButton:false
                        })
                        hasNullMes = true;
                        return
        ...
        function submitData() {
            ...
            var data = {
                id : $("#id").val(),
                nianxianstart : $("#nianxianstart").val(),
                nianxianend : $("#nianxianend").val(),
                fenshu : $("#fenshu").val(),
            };
            var url = "gongzuonianxianxiugai";
            $.ajax({
                url : url,
                type : "post",
                data : data,
            ...
            setTimeout(function(){
                window.location.href="../guanliyuan/gongzuonianxianguanli";
            }, 3000);
                ...
                $.ajax({
                    ...
                    success : function (pb) {
                        ...
                        for (var i = 0; i < pb.list.length; i++) {
                            ...
                            var li='<tr>\n' +
                                    '                <td> '+teacher.id+'</td>\n' +
                                    '                <td> '+teacher.nianxianstart+'</td>\n' +
                                    '                <td> '+teacher.nianxianend+'</td>\n' +
                                    '                <td> '+teacher.fenshu+'</td>\n' +
                                    '                <td>\n' +
                                    '                    <a  href="#" id="edit" class="edit" >编辑</a>\n' +
                                    '                    <a  href="gongzuonianxiandel?gongzuonianxianid='+teacher.id+'" id="del" class="del">删除</a>\n' +
                                    '                </td>\n' +
                                    '            </tr>';
                            lis+=li;
                        }
                ...
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            ...
                            <li><a  class="active" href="gongzuonianxianguanli"><span>工作年限管理</span></a></li>
                                ...
                                <div class="modal-body">
                                    <table id="xztb" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>年限开始</label></td>
                                            <td><input  id="nianxianstart" name="nianxianstart" class="nianxianstart" type="text" placeholder="请输入年限开始"/></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>年限结束</label></td>
                                            <td><input id="nianxianend" name="nianxianend" class="nianxianend" type="text" placeholder="请输入年限结束"/></td>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>分数</label></td>
