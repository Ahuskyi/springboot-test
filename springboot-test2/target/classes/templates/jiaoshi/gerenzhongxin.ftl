        ...
        function submitData() {
            ...
            $.ajax({
                ...
                success : function (map) {
                    ...
                    setTimeout(function(){
                        window.location.href="../jiaoshi/gerenzhongxin?dengluren="
                    }, 3000);
                },
            ...
            <div class="lsm-sidebar">
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            <li><a href="peixunziliaoguanli"><span>岗前培训资料</span></a></li>
                                ...
                                <div class="modal-body">
                                    <table id="xztb" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><input  id="dianhua" name="dianhua" class="dianhua" type="text" placeholder="请输入用户名"/></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
