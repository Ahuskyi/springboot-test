        ...
        function submitData() {
            ...
            $.ajax({
                ...
                success : function (map) {
                    ...
                    setTimeout(function(){
                        window.location.href="../guanliyuan/xueweiguanli";
                    }, 3000);
                },
                    ...
                    success : function (pb) {
                        ...
                        for (var i = 0; i < pb.list.length; i++) {
                            ...
                            var li='<tr>\n' +
                                    ...
                                    '                    <a  href="xueweidel?xueweiid='+teacher.id+'" id="del" class="del">删除</a>\n' +
                                    '                </td>\n' +
                                    '            </tr>';
                            lis+=li;
                        }
                                ...
                                <div class="modal-body">
                                    <table id="xztb" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>学位</label></td>
                                            <td><input  id="xuewei" name="xuewei" class="xuewei" type="text" placeholder="请输入学位"/></td>
                                        </tr>
                                        <tr>
