    ...
    <script>
        ...
        $(function () {
            ...
            var methods = {
                ...
                editHandle: function (the_index) {
                    ...
                    tarInp.eq(6).attr("value",nowConArr[6].toString().trim());
                    for (var p=0;p<tarSel.length;p++) {
                        var the_p = p+tarInp.length;
        ...
        function submitData() {
            ...
            var data =
                {
                id : $("#id").val(),
                kechenghao : $("#kechenghao").val(),
                kechengmingcheng : $("#kechengmingcheng").val(),
                xuefen : $("#xuefen").val(),
                xueshi : $("#xueshi").val(),
                jiaoxuedagang : $("#jiaoxuedagang").val(),
                chuangjianshijian: $("#chuangjianshijian").val(),
            };
            var url = "kechengxiugai";
            $.ajax({
                url : url,
                type : "post",
                data : data,
        ...
        function loaddate(currentPage) {
                ...
                var data = {
                    ...
                    id:$("#search_id").val(),
                    kechenghao:$("#search_kechenghao").val(),
                    kechengmingcheng:$("#search_kechengmingcheng").val(),
                }
                var url = "kechengfenye"
                $.ajax({
                    url : url,
                    type : "get",
                    data : data,
                    ...
                    success : function (pb) {
                        ...
                        for (var i = 0; i < pb.list.length; i++) {
                            var kecheng=pb.list[i];
                            var li='<tr>\n' +
                                    '                <td> '+kecheng.id+'</td>\n' +
                                    '                <td> '+kecheng.kechenghao+'</td>\n' +
                                    '                <td> '+kecheng.kechengmingcheng+'</td>\n' +
                                    '                <td> '+kecheng.xuefen+'</td>\n' +
                                    '                <td> '+kecheng.xueshi+'</td>\n' +
                                    '                <td><a href="${request.contextPath}/images/'+kecheng.jiaoxuedaganglujing+'">'+kecheng.jiaoxuedagang+'</a></td>\n' +
                                    '                <td> '+kecheng.chuangjianshijian+'</td>\n' +
                                    '                <td>\n' +
                                    '                    <a  href="#" id="edit" class="edit" >编辑</a>\n' +
                                    '                    <a  href="kechengdel?kechengid='+kecheng.id+'" id="del" class="del">删除</a>\n' +
                                    '                </td>\n' +
                                    '                <td>\n' +
                                    '                    <a href="jiaoxueUpload?kechengid='+kecheng.id+'"  >上传附件</a>\n' +
                                    '                </td>\n' +
                                    '            </tr>';
                            lis+=li;
                        }
            ...
            <div class="lsm-sidebar">
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            <li><a class="active" href="kechengguanli"><span>课程管理</span></a></li>
                ...
                <div class="container content_width">
                    <div class="person_search">
                        ...
                        <div class="search_input">
                            <div class="input-group mb-3">
                                <span>课程号：</span>
                                <input id="search_kechenghao" type="text" class="form-control" placeholder="请输入课程号">
                            </div>
                        </div>
                        <div class="search_input">
                            <div class="input-group mb-3" >
                                <span>课程名称：</span>
                                <input id="search_kechengmingcheng" type="text" class="form-control" placeholder="请输入课程名称">
                            </div>
                        </div>
                        <div class="search_input">
                                ...
                                <div class="modal-body">
                                    <table id="xztb" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>课程号</label></td>
                                            <td><input  id="kechenghao" name="kechenghao" class="kechenghao" type="text" placeholder="请输入课程号"/></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for=""><font style="font-size: 14px; color: red;">*</font>课程名称</label></td>
                                            <td><input id="kechengmingcheng" name="kechengmingcheng" class="kechengmingcheng" type="text" placeholder="请输入课程名称"/></td>
                                            <td class="tb_bg"><label for="">学分</label></td>
                                            <td><input id="xuefen" name="xuefen" type="text" placeholder="请输入学分"/></td>
                                        </tr>
                                        <tr>
                                            <td class="tb_bg"><label for="">学时</label></td>
                                            <td><input id="xueshi" name="xueshi" type="text" placeholder="请输入学时"/></td>
                                            <td class="tb_bg"><label for="">教学大纲</label></td>
                                            <td><input id="jiaoxuedagang" name="jiaoxuedagang" type="text" placeholder="请输入教学大纲"/></td>
