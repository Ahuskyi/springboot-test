        ...
        <div class="box" style="margin-left: 240px;">
            <div class="container content_width">
                <div class="person_search">
                    <div class="title">试讲档案附件上传</div>
                </div>
                <div class="line"></div>
            </div>
            <div>
            <#--<div style="float: left;width: 200px;height: 400px">-->
                <#--<form action="shijiangneirongUpload" method="post" enctype="multipart/form-data">-->
                    <#--<p>上传试讲内容: <input type="file" name="fileName"/></p>-->
                    <#--<p><input type="submit" value="提交"/></p>-->
                <#--</form>-->
            <#--&lt;#&ndash;判断是否上传文件&ndash;&gt;-->
<#--<#if shijiangneirongmsg??>-->
<#--<span>${shijiangneirongmsg}</span><br>-->
<#--<#else >-->
<#--<span>${shijiangneirongmsg!("文件未上传")}</span><br>-->
<#--</#if>-->
            <#--&lt;#&ndash;显示图片，一定要在img中的src发请求给controller，否则直接跳转是乱码&ndash;&gt;-->
<#--<#if shijiangneirong??>-->
<#--<img src="/guanliyuan/show?fileName=${shijiangneirong}" style="width: 200px"/>-->
<#--<#else>-->
...
<#--</#if>-->
            ...
            <div style="float: left;width: 200px;height: 400px">
                <form action="shijiangfenshuUpload" method="post" enctype="multipart/form-data">
                    <p>上传试讲听课记录: <input type="file" name="fileName"/></p>
                    <p><input type="submit" value="提交"/></p>
                </form>
<#if shijiangfenshumsg??>
<span>${shijiangfenshumsg}</span><br>
<#else >
<span>${shijiangfenshumsg!("文件未上传")}</span><br>
</#if>
<#if shijiangfenshu??>
<img src="/guanliyuan/show?fileName=${shijiangfenshu}" style="width: 200px"/>
<#else>
<img src="/guanliyuan/show" style="width: 100px"/>
</#if>
            </div>
