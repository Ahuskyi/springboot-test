        ...
        <div class="box" style="margin-left: 240px;">
            ...
            <div>
             <div style="float: left;width: 200px;height: 400px">
                <form action="shenfenzhengUpload" method="post" enctype="multipart/form-data">
                    <p>上传身份证照片: <input type="file" name="fileName"/></p>
                    <p><input type="submit" value="提交"/></p>
                </form>
            <#--判断是否上传文件-->
<#if shenfenzhengmsg??>
<span>${shenfenzhengmsg}</span><br>
<#else >
<span>${shenfenzhengmsg!("文件未上传")}</span><br>
</#if>
            <#--显示图片，一定要在img中的src发请求给controller，否则直接跳转是乱码-->
<#if shenfenzheng??>
<img src="/guanliyuan/show?fileName=${shenfenzheng}" style="width: 200px"/>
<#else>
<img src="/guanliyuan/show" style="width: 100px"/>
        ...
        <#--<简历>-->
             <div style="float: left;width: 200px;height: 400px">
                <form action="jianliUpload" method="post" enctype="multipart/form-data">
                    <p>上传简历照片: <input type="file" name="fileName"/></p>
                    <p><input type="submit" value="提交"/></p>
                </form>
            <#if jianlimsg??>
<span>${jianlimsg}</span><br>
            <#else >
<span>${jianlimsg!("文件未上传")}</span><br>
            </#if>
            <#--显示图片，一定要在img中的src发请求给controller，否则直接跳转是乱码-->
<#if jianli??>
<img src="/guanliyuan/show?fileName=${jianli}" style="width: 200px"/>
<#else>
<img src="/guanliyuan/show" style="width: 100px"/>
</#if>
            </div>
        <#--<学位证>-->
            <div style="float: left;width: 200px;height: 400px">
                <form action="xueweizhengUpload" method="post" enctype="multipart/form-data">
                    <p>上传学位证照片: <input type="file" name="fileName"/></p>
                    <p><input type="submit" value="提交"/></p>
                </form>
                <#if xueweizhengmsg??>
                <span>${xueweizhengmsg}</span><br>
                <#else >
                <span>${xueweizhengmsg!("文件未上传")}</span><br>
                </#if>
                <#if xueweizheng??>
                <img src="/guanliyuan/show?fileName=${xueweizheng}" style="width: 200px"/>
                <#else>
                <img src="/guanliyuan/show" style="width: 100px"/>
                </#if>
            </div>
        ...
        <#--<学历证>-->
            <div style="float: left;width: 200px;height: 400px">
                <form action="xuelizhengUpload" method="post" enctype="multipart/form-data">
                    <p>上传学历证照片: <input type="file" name="fileName"/></p>
                    <p><input type="submit" value="提交"/></p>
                </form>
<#if xuelizhengmsg??>
<span>${xuelizhengmsg}</span><br>
<#else >
<span>${xuelizhengmsg!("文件未上传")}</span><br>
</#if>
<#if xuelizheng??>
<img src="/guanliyuan/show?fileName=${xuelizheng}" style="width: 200px"/>
<#else>
<img src="/guanliyuan/show" style="width: 100px"/>
</#if>
            </div>
        <#--<职称证>-->
            <div style="float: left;width: 200px;height: 400px">
                <form action="zhichengzhengUpload" method="post" enctype="multipart/form-data">
                    <p>上传职称证照片: <input type="file" name="fileName"/></p>
                    <p><input type="submit" value="提交"/></p>
                </form>
<#if zhichengzhengmsg??>
<span>${zhichengzhengmsg}</span><br>
<#else >
<span>${zhichengzhengmsg!("文件未上传")}</span><br>
</#if>
<#if zhichengzheng??>
<img src="/guanliyuan/show?fileName=${zhichengzheng}" style="width: 200px"/>
<#else>
<img src="/guanliyuan/show" style="width: 100px"/>
</#if>
            </div>
        <#--<综合水平分数>-->
            <div style="float: left;width: 200px;height: 400px">
                <form action="zongheshuipingfenshuUpload" method="post" enctype="multipart/form-data">
                    <p>上传综合水平分数照片: <input type="file" name="fileName"/></p>
                    <p><input type="submit" value="提交"/></p>
                </form>
<#if zongheshuipingfenshumsg??>
<span>${zongheshuipingfenshumsg}</span><br>
<#else >
<span>${zongheshuipingfenshumsg!("文件未上传")}</span><br>
</#if>
<#if zongheshuipingfenshu??>
<img src="/guanliyuan/show?fileName=${zongheshuipingfenshu}" style="width: 200px"/>
<#else>
<img src="/guanliyuan/show" style="width: 100px"/>
</#if>
            </div>
