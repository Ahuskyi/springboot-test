...
<#--<分页>-->
    ...
    <script>
        ...
        function submitData() {
            ...
            var data = {
                id : $("#id").val(),
                banjimingcheng: $("#banjimingcheng").val(),
            };
            var url = "banjixiugai";
            $.ajax({
                url : url,
                ...
                success : function (map) {
                    alert(map.result);
                    setTimeout(function () {
                        location.href = "../guanliyuan/banjiguanli";
                    }, 3000);
                }
            })
            }
        ...
        function loaddate(currentPage) {
                ...
                var data = {
                    ...
                    id:$("#search_id").val(),
                    banjimingcheng:$("#search_banjimingcheng").val(),
                }
                var url = "banjifenye"
                $.ajax({
                    url : url,
                    ...
                    success : function (pb) {
                        ...
                        for (var i = 0; i < pb.list.length; i++) {
                            ...
                            var li='<tr>\n' +
                                    '                <td> '+banji.id+'</td>\n' +
                                    '                <td>'+banji.banjimingcheng+'</a></td>\n' +
                                    '                <td>\n' +
                                    '                    <a  href="#" id="edit" class="edit" >编辑</a>\n' +
                                    '                    <a  href="banjidel?banjiid='+banji.id+'" id="del" class="del">删除</a>\n' +
                                    '                </td>\n' +
                                    '            </tr>';
                            lis+=li;
                        }
                ...
                <ul>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            ...
                            <li><a  class="active" href="xueweiguanli"><span>学位管理</span></a></li>
                    ...
                    <li class="lsm-sidebar-item">
                        ...
                        <ul>
                            <li><a class="active" href="banjiguanli"><span>班级管理</span></a></li>
                ...
                <div class="container content_width">
                    <div class="person_search">
                        ...
                        <div class="search_input">
                            <div class="input-group mb-3" >
                                <span>班级名称：</span>
                                <input id="search_banjimingcheng" type="text" class="form-control" placeholder="请输入班级名称">
                            </div>
                        </div>
                        <div class="search_input">
                                ...
                                <div class="modal-body">
                                    <table id="xztb" class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td><input  id="banjimingcheng" name="banjimingcheng" class="banjimingcheng" type="text" placeholder="请输入班级名称"/></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
